...
# Description
# Uses MPlayer to watch a sequence of JPEG files inside a folder at 12 FPS. 
# The script should be ran inside that same folder (double-click on it for 
# easinness of use).
...
mplayer "mf://*.jpg" -mf fps=12:type=jpg -brightness 0 -fs
