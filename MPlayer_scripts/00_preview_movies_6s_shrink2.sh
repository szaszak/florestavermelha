...
# Description
# This script generates a very quick preview of 6s, at 1/2 movie original
...
# it and 1s after it for the preview. The idea here is to be fast but to have
# a larger frame as reference; if you want a full-res preview, use the 
# other scripts on this folder.
